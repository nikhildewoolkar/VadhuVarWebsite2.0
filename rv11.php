...
$hashedpassword1 = password_hash($password1, PASSWORD_DEFAULT); // Creates a password hash
    ...
    $sql = "INSERT INTO register (fname, mname, lname, gender, date1, month1, year1, m_status, nc, clwm, religion, caste, subcaste, created_by, emailid, password1, mobile1, mobile2, gothra, moonsign, horos, manglik, birth_village, birth_city, birth_taluka, birth_district, birth_state, birth_country, birth_hour, birth_min, ampm, height_cm, weight_kg, blood, complexion, p_status, physicalsts, body_type, qualification, qstream, occupation, address, txtadd_tal, add_city, add_district, add_state, add_country, diet, smoke, drink, username)  VALUES ('$fname', '$mname', '$lname', '$gender', '$date1', '$month1', '$year1', '$m_status', '$nc', '$clwm', '$religion', '$caste', '$subcaste', '$created_by', '$emailid',          '$hashedpassword1', '$mobile1', '$mobile2', '$gothra', '$moonsign', '$horos', '$manglik', '$birth_village', '$birth_city', '$birth_taluka', '$birth_district', '$birth_state', '$birth_country', '$birth_hour',    '$birth_min', '$ampm', '$height_cm', '$weight_kg', '$blood', '$complexion', '$p_status',             '$physicalsts', '$body_type', '$qualification', '$qstream','$occupation', '$address', '$address1', '$add_city', '$add_district', '$add_state', '$add_country', '$diet', '$smoke', '$drink', '$username1')";
...
<section class="titleWrapper">
  ...
  <section class="wrapper">
	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" name="reg_form" id="reg_form">
      ...
      <div class="registration">
        ...
        <div class="col-sm-4">
           <label><b><font color="red">*&nbsp;&nbsp;</font></b>Middle Name</label>
             <input id="txtMName" class="form-control" type="text" name="txtMName" required maxlength="20" placeholder="Max 20 characters">
        </div>

          <div class="col-sm-4">
		    <label><b><font color="red">*&nbsp;&nbsp;</font></b>Last Name</label>
            <input id="txtLastName" class="form-control" type="text" name="txtLastName" required maxlength="20" placeholder="Max 20 characters">
          </div>  
        </div>
        <div class="form-group row">
          <div class="col-sm-6">
		...
		<div id="showopd" style="display:none">
          ...
          <div class="col-sm-4">
            <label>Religion</label>
                <!--<select data-ref-type="reg-caste" id="religion" class="forminpt js-religion form-control" name="religion" required>
        </select> -->
        <input id="religion" class="form-control" type="text" name="religion" maxlength="20" value="Hindu" disabled>
          </div>
          
           <div class="col-sm-4">
              <label>Cast</label>
           <!-- <select style="width:220px;" data-ref-type="reg-caste" id="caste" class="forminpt js-caste form-control" name="caste" required>
        </select> -->
        <input id="caste" class="form-control" type="text" name="caste" value="Maratha" maxlength="20" disabled>
         ...
         <!--  <select data-ref-type="reg-caste" data-sub-caste-fld-name="txtSubcaste" id="sub_caste" class="forminpt js-sub-caste form-control" name="txtSubcaste" disabled="disabled" required>
          ...
          <input id="txtSubcaste" class="form-control" type="text" name="txtSubcaste" maxlength="20">
      </div>
      <br><br><br><br>
      <div class="col-sm-4">
...
<div class="registration">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <label>City</label>
      <input id="txtadd_city" required class="form-control" type="text" name="txtadd_city" maxlength="20">
    </div>
    <div class="col-sm-4">
      <label><b><font color="red">*&nbsp;&nbsp;</font></b>Taluka</label>
      <input id="txtaddress1" class="form-control" type="text" name="txtaddress1" maxlength="20" required>
    </div>
    <br><br>
    <div class="col-sm-4">
    ...
    <div class="col-sm-4">
      ...
      <!-- <input id="txtadd_country" required class="form-control" type="text" name="txtadd_country" maxlength="20">-->            
		...
		<div class="form-group row">
  	    ...
  	    <div class="form-group row">
          <div class="col-sm-4">
		  <label><b><font color="red">*&nbsp;&nbsp;</font></b>Email ID</label>
		...
		<div class="form-group row">
		  ...
		  <label><b><font color="red">*&nbsp;&nbsp;</font></b>Mobile Number</label>
            <input id="txtMobile" class="form-control" type="text" name="txtMobile" required onfocusout="chk_mobile1()">
            <script>
		  ...
		  <label>Alternate Contact Number</label>
            <input id="txtPhone" class="form-control" type="text" name="txtPhone" onfocusout="chk_mobile2()" >
            <script>
...
knowledge and I bear the responsibility for the correctness of the above mentioned particulars.</b>
          ...
          <div class="checkbox">
           ...
           <input type="submit" value="Submit" class="btn btnpink loginbtn btn-lg" style="background : #ff6600">
        </div>
